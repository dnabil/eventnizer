    ...
    <div class="d-flex justify-content-center align-items-center my-5">
        <div class="registrasi text-center col-xl-5 col-md-12 ">
            ...
            <form action="/product-update" method="POST">
                    ...
                    <div class="row center-form justify-content-center align-items-center">
                        ...
                        <div class="form-group col-sm-10">
                            <input class="form-control transparent-input  @error('min_price') is-invalid @enderror"
                                type="number" id="min_price" placeholder="Harga minimal" name="min_price"
                        ...
                        <div class="form-group col-sm-10">
                            <input class="form-control transparent-input  @error('max_price') is-invalid @enderror"
                                type="number" id="max_price" placeholder="Harga maksimal" name="max_price"
                                value="{{ $product->max_price }}" required />
                        </div>
                        @error('max_price')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                        ...
                        <div class="form-group col-sm-10">
                            <textarea class="form-control  @error('description') is-invalid @enderror" id="exampleFormControlTextarea1"
                                rows="3" placeholder="Deskripsi produk" name="description" id="description" required>{{ $product->description }}</textarea>
                        </div>
                        @error('description')
                            <div class="invalid-feedback d-block">
                                {{ $message }}
                ...
                <input name="slug" class="invisible" type="hidden" value="{{ $product->slug }}">
                <input class="button button-pink" type="submit" value="Edit" />
            </form>
